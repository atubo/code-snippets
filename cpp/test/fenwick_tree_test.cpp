...
class FenwickTreeTest:public CppUnit::TestFixture {
 public:
  ...
  void testSetAndGet() {
    ...
    CPPUNIT_ASSERT_EQUAL(int64_t(0), ft.query(1));
    CPPUNIT_ASSERT_EQUAL(int64_t(1), ft.query(2));
    CPPUNIT_ASSERT_EQUAL(int64_t(1), ft.query(3));
    CPPUNIT_ASSERT_EQUAL(int64_t(3), ft.query(4));
  }
